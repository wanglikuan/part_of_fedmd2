...
#---------------------------------------
        ...
        dicts = []
        total_private_data = {}
        dicts.append(total_private_data1)
        dicts.append(total_private_data2)        
        for d in dicts:
            for k, v in d.items():
        ...
        dicts_private = []
        private_test_data = {}
        dicts_private.append(private_test_data1)
        dicts_private.append(private_test_data2)        
        for d in dicts_private:
            for k, v in d.items():
                #total_private_data.setdefault(k, []).append(v)
                try:
